...
import FormInput from "../components/iputs/FormInput";
    ...
    try {
      ...
      Object.entries(payload).forEach(([key, value]) => {
        ...
        if (Array.isArray(value)) {
          value.forEach((item) => infoFormData.append(`${key}[]`, item));
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="space-y-3 w-full px-6">
            ...
            <div className="flex flex-col gap-3">
              <button className="w-full bg-sky-500 text-white py-3 rounded-xl font-medium bg-gradient-to-r from-indigo-500 to-violet-500">
